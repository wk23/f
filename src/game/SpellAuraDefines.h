...
enum AuraType
{
    ...
    SPELL_AURA_MOD_IGNORE_ABSORB_SCHOOL  = 194,                     // not used now, old SPELL_AURA_MOD_SPELL_DAMAGE_OF_INTELLECT
    SPELL_AURA_MOD_IGNORE_ABSORB_FOR_SPELL  = 195,                     // not used now, old SPELL_AURA_MOD_SPELL_HEALING_OF_INTELLECT
